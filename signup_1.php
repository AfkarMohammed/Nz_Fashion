  ...
  <div class="container" >
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-5 offset-lg-4 offset-md-4">
          <h2 class="text-center badge-success">SIGN UP</h2>
          <hr>

          <form class="" action="signup_2.php" method="post">

            <div class="form-row align-item-left">

               <div class="form-group col-lg-12 col-md-12">

                  <label class="label mx-1" for="name">E-Mail</label>
                    ...
                    <input type="email" class="form-control "
                     id="email" name="email" placeholder="use your email address">
							...
							<div class="form-group col-lg-12 col-md-12">
								 ...
								 <label class="label mx-1" for="name">Full Name</label>
								 <div class="input-group mx-1 mb-2 ">
									 <div class="input-group-prepend">
										 <div class="input-group-text">
											 <i class="fas fa-user"></i>
									 ...
									 <input type="text" class="form-control "
										id="cus_name" name="cus_name" placeholder="Enter your full name">
							 </div>
						 </div><!-- end of form group size 6-->
						 ...
						 <div class="form-group col-lg-12 col-md-12">
								...
								<div class="input-group mx-1 mb-2 ">
									...
									<textarea class="form-control" name="address" id="address"placeholder="Enter the Address"
             ...
             <div class="form-group col-lg-12 col-md-12">
               <label class="label mx-1" for="signup"><a href="userlogin_1.php">All Ready have an Account? Login.</a></label>
             </div>

             <div class="form-group col-lg-12 col-md-12">

                  <input type="submit" id="btnSubmit" class="col-6 btn btn-dark "
