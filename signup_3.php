            ...
            if($_REQUEST['status']=="pass"){
              ...
              ?>
                  <div class="alert alert-success alert-dismissible fade show" role="alert">
                    ...
                    <strong>Awesome </strong> User Account Successfully Created.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                    <br />
                    <a href="userlogin_1.php" class="btn btn-success my-3">login Here</a>
                  </div>
              <?php
            }
            else{
              ...
              ?>
                  <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <h2>Account Creating failed!!!</h2>
                    <strong>Sorry</strong> User Account Creating failed. Pleas try again.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                    <br />
                    <a href="signup_1.php" class="btn btn-danger my-3">Try again</a>
                  </div>
