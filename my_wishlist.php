...
$get_customer = "select * from customer_log where email_id='$email'";
...
$run_wishlist = mysqli_query($mysqli,$get_wishlist);

while($row_wishlist = mysqli_fetch_array($run_wishlist)){

$wishlist_id = $row_wishlist['wishlist_id'];

$product_id = $row_wishlist['pid'];

$get_products = "select * from product where pid='$product_id'";
...
$product_url = $row_products['description'];

$product_img1 = $row_products['picture'];
